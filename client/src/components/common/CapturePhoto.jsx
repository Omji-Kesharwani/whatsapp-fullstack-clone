...
hide(false);
  ...
  return <div className="absolute h-4/6 w-3/6 top-1/4 left-1/3 bg-gray-900 gap-3 rounded-lg p-2 flex items-center justify-center">
    <div className="flex flex-col gap-4 w-full items-center justify-center">
    <div className=" justify-end  flex items-end pt-2 pr-2 cursor-pointer "onClick={()=>hide(false)}>
