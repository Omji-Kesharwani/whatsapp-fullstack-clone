...
function SearchBar() {
  ...
  return (
    <div className="bg-search-input-container-background flex py-3 pl-5 items-center gap-3 h-14 w-full">
      <div className="bg-panel-header-background flex items-center gap-5 py-1 rounded-lg flex-grow w-full px-3">
        ...
        <div className="w-full">
          <input
            ...
            value={contactSearch}
            onChange={e=>dispatch({type:reducerCases.SET_CONTACTS_SEARCH,
